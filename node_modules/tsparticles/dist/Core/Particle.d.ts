...
import { MoveDirection, RotateDirection, ShapeType, MoveDirectionAlt, RotateDirectionAlt } from "../Enums";
...
export declare class Particle implements IParticle {
    ...
    angle: number;
    destroyed: boolean;
    rotateDirection: RotateDirection | keyof typeof RotateDirection | RotateDirectionAlt;
    ...
    private readonly strokeColorVelocity?;
